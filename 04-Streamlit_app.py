...
@st.cache_data
def load_data():
    SHAPEFILE_PATH = "County_Boundaries_-_Extended\County_Boundaries_-_Extended.shp"
    # print(SHAPEFILE_PATH)
    # exit()
    EMISSIONS_CSV_PATH = "aggregated_results.csv"
    EMISSIONS_DIFF_PATH = "aggregated_results_difference.csv"
